...
<?php 
	...
	//var_dump($ostatus);
	$sql = "select a.*,b.payname from donhang a,payment b where a.payid=b.payid and Trangthaidon=".$ostatus."";
					...
					<?php 
						if ($result->num_rows>0){
							...
							<tr>
								...
								?></td>
								<td><a href="Qlyxacnhandon.php?Madonhang=<?php echo $r["Madonhang"];?>">Order Detail</a></td>
							</tr>
