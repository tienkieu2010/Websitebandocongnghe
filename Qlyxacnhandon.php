...
<main>
    ...
    <?php
        $detail = $conn->query("select * from payment a,user b,donhang c where c.payid=a.payid and Madonhang=$Madonhang");
    ...
    ?>
            ...
            <div class="buttonxnh">
                <?php
                    ...
                    {
                ?>
                <a href="chagestatusadmin.php?Madonhang=<?php echo $detailtt["Madonhang"] ?>" onclick="return confirm('Bạn có chắc chắn muốn xác nhận đơn không?');">
                    <input type="button" value="Xác nhận vận chuyển đơn hàng">
                </a>
                ...
                <?php
                    if($detailtt["Trangthaidon"]==1)
                    {
                ?>
                <a href="chagestatusadmin.php?Madonhang=<?php echo $detailtt["Madonhang"] ?>" onclick="return confirm('Bạn có chắc chắn xác nhận đơn đang giao không?');">
                    <input type="button" value="Xác nhận đơn hàng đang giao">
                </a>
...
<?php
                    if($detailtt["Trangthaidon"]==2)
                    {
                ?>
                <a href="chagestatusadmin.php?Madonhang=<?php echo $detailtt["Madonhang"] ?>" onclick="return confirm('Bạn có chắc chắn xác nhận hoàn thành đơn hàng không?');">
                    <input type="button" value="Xác nhận hoàn thành đơn hàng">
                </a>
